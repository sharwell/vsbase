namespace Tvl.VisualStudio.Shell
{
    ...
    public static class IConnectionPointContainerExtensions
    {
        ...
        {
            private readonly WeakReference _connectionPoint;
            ...
            public ConnectionPointCookie(IConnectionPoint connectionPoint, uint cookie)
            {
                ...
                _connectionPoint = new WeakReference(connectionPoint);
                _cookie = cookie;
            }
            ...
            public void Dispose()
            {
                if (_cookie != 0)
                {
                    IConnectionPoint connectionPoint = (IConnectionPoint)_connectionPoint.Target;
                    if (connectionPoint != null)
                    {
